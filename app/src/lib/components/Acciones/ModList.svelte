        ...
        {#each estado.sorts as orden, i}
            <div class="mod">
                ...
                <select
                    ...
                    onchange={(e) => actualizarOrden(i, { ...orden, direction: e.currentTarget.value as 'asc' | 'desc' })}
                >
        ...
        {#each estado.filters as filtro, i}
            ...
            <div class="mod">
                ...
                <select
                    ...
                    onchange={(e) => actualizarFiltro(i, { ...filtro, operator: e.currentTarget.value as Operator })}
                >
